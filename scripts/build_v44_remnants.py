...
remnants = '''
      <section id="rRemnants" class="section"><div class="kicker">6 · REMNANT ENGINE</div><h2>Remnants are a separate Mana-recovery lever</h2><p class="sectionIntro">Do not fold Remnants into ordinary regeneration. Mana Remnants can Overflow maximum Mana, while the passive notables add extra recovery, duplicate-effect chance and additional-remnant generation. That makes Remnants useful for both sustain and pre-Flare current-Mana spikes.</p>
        ...
        <div class="deepGrid" style="margin-top:12px"><article class="deepCard highlightBlue"><h3>How to model Remnants</h3><p>Keep the compact calculator honest: estimate your <b>average Mana recovered from Remnants per second</b> and place that number in <b>Other Mana recovery / sec</b>. Do not automatically turn every theoretical spawn into recovery because pickup rate, ailment uptime and the skill's internal spawn timing matter.</p></article><article class="deepCard"><h3>Overflow trick</h3><p>Mana Remnants can Overflow maximum Mana. If Remnants or Uhtred push current Mana above maximum, enable the calculator's Overflow toggle and set Current Mana above 100%. That directly increases Mana Flare's 25%-of-current-Mana base.</p></article></div>
