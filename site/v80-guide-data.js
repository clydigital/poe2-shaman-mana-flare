window.MANA_GEYSER_GUIDE = {
  nodes: [
    ...
    {name:'Arcane Remnants', bucket:'Remnants', effect:'Improves the Mana Remnants recovery engine and raises the value of remnant-focused sustain.', grade:'A', status:'RECOMMENDED'},
    {name:'Empowering Remnants', bucket:'Remnants', effect:'Improves Remnant effect; strongest when Mana Remnants is a real part of sustain rather than incidental pickup recovery.', grade:'A', status:'RECOMMENDED'},
    {name:'Remnant Attraction', bucket:'Remnants', effect:'Increases practical pickup reach so Remnant recovery is collected more consistently while moving.', grade:'B', status:'OPTIONAL'},
  ...
  progression: [
    {stage:'ACT 1', level:'1–15', goal:'Build the Mana/crit shell', items:['Rare Wand: Spell Damage / Crit / Mana','Rare ES pieces with Mana or Intelligence','Dream Fragments from level 12 if affordable'], notes:'Mana, resistances and a reliable crit carrier matter more than expensive temporary damage.'},
    {stage:'ACT 2', level:'16–30', goal:'Turn on the real Mana-Flare engine', items:['Sands of Silk (16) as a cheap bridge','Serpent’s Lesson (22) only as an experiment','Crest of Ardura (28) for CDR + recovery','Second Dream Fragments when it clearly beats the rare ring'], notes:'Entangle/Frost Darts + Mana Flare begins to define the build here.'},
    {stage:'ACT 3', level:'31–45', goal:'Eldritch Battery + real Mana stacking', items:['High-ES helmet/body upgrades','Rare Wand with gain-as-extra / Spell Damage / Crit','Visage of Ayah only while it is the cleanest EB enabler','Nightscale / Maligaro’s at 45 only if they beat a strong rare'], notes:'Gear is judged by final Mana + recovery + crit together rather than one isolated affix.'},
    {stage:'ACT 4', level:'46–64', goal:'Solve sustain before buying more CDR', items:['Lavianga’s Spirits (49) only for comfort','Waistgate (50)','Uhtred’s Chalice (50)','Waveshaper (51) as a defensive bridge','Strugglescream (52) once four instills beat Astramentis'], notes:'Permanent Archmage starts when current Mana remains healthy through a real fight.'},
    {stage:'EARLY ATLAS', level:'65–80', goal:'Choose the endgame chassis', items:['Cloak of Defiance (65) defensive route','Adonia’s Ego (65) hybrid wand option','Exceptional 2-socket rare Wand','Cultivated Rathpith when the Mana cultivations are good','Morior vs high-ES + %Mana rare chest: compare final Mana'], notes:'The main target is 4k → 6k permanent Mana while repeatable recovery climbs toward 35–40% of maximum Mana per second.'},
    {stage:'ENDGAME', level:'80+', goal:'Push 7.5–10k+ without Runeseeker', items:['Huge pure-ES helmet','Exceptional augment-effect gloves/boots','High-end Mana/%Mana/INT/regen jewellery','Morior socket-max or high-ES rare chest','Jiquani + Darkness Enthroned only as aspirational BIS'], notes:'The finished chassis remains coherent without Runeseeker; Runeseeker stays an economic/farming objective rather than the build foundation.'}
  ]
};